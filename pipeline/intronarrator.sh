#!/bin/bash
#RUN AS FOLLOWS:
#./intronarrator.sh AUGUSTUS_DIR ORGANISM GENOME RNA-seq
#
...
# AUGUSTUS section how $1 to $4 are processed to set the right paths.
...
ASM=$3 #Genome assembly prefix without ".fa" extension
BAM_PREFIX=$4 #BAM prefix containing all mapped RNA-seq reads (minus ".bam"
...
augustus_gff_to_proper_gff.py $ASM_M.final.gff > $ASM_M.final.proper.gff
